...
class WZMLStyle:
    ...
    ST_BN2_NAME = '😘 Use Me'
    ST_BN2_URL = 'https://t.me/RM_Leech'
...
<a href="https://t.me/RM_Movie_Flix"><b>Pᴏᴡᴇʀᴇᴅ ʙʏ -𝚁𝙼 𝙼𝚘𝚟𝚒𝚎 𝙵𝚕𝚒𝚇 🚀♥️</b></a>
...
------------------------------------------\n\n"""
    ...
    NAME =                  '┏<b>🏷️ Name ~𝙅𝙤𝙩:</b> <code>{Name}</code>\n'
    SIZE =                  '┠<b>💾 Size: </b>{Size}\n'
    ...
    COUNT_CC =   '┗<b>👤 User: </b>{COUNT_CC}\n\n<a href="https://t.me/Contact_Jot_Bot"><b>♥️ ~𝙅𝙤𝙩</b></a>'
    # ---------------------
